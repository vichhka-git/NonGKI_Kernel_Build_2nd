...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|  
| Oneplus 7 Series | All | guacamoleb | [4.14/LineageOS/sm8150](https://github.com/LineageOS/android_kernel_oneplus_sm8150) | LineageOS 23.2 | 16 | AnyKernel3 | ReSukiSU | ✅ | Syscall | ❌ | ❌ | ❌ | Stable |
...
**English**:  
- OnePlus 7 Series (SM8150) covers OnePlus 7 (guacamoleb), 7 Pro (guacamole), 7T (hotdogb), and 7T Pro (hotdog). Built from the LineageOS android_kernel_oneplus_sm8150 source on lineage-23.2 branch.
...
**Chinese**:  
- 一加 7 系列（SM8150）覆盖一加 7（guacamoleb）、7 Pro（guacamole）、7T（hotdogb）和 7T Pro（hotdog），基于 LineageOS android_kernel_oneplus_sm8150 源码 lineage-23.2 分支构建。
